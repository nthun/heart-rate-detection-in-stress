...
We fitted linear regressions on the experienced (subjective) HR change for each task (cognitive1, cognitive2, and physical). We investigated if actual (ECG measured) HR change in the respective tasks predicted subjective HR change, and if expectations predicted subjective HT change better. We included sex, body fat percent, and task order as covariates.
